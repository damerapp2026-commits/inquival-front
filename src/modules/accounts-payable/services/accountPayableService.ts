...
export const accountPayableService = {
  ...
  registerPayment: (id: string, data: { amount: number; codigoTransferencia?: string; notes?: string; paymentDate?: string; paymentMethodId?: string }) => api.post(`/accounts-payable/${id}/payments`, data).then((r) => r.data.data),
