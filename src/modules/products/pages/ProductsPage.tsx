      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4">
        ...
        {view === 'list' && (
          <div className="flex flex-wrap gap-2">
            <button onClick={() => { const url = `${window.location.origin}/lista-productos`; window.open(`https://wa.me/?text=${encodeURIComponent(`Mira nuestro catalogo de productos: ${url}`)}`, '_blank'); }} className="flex items-center gap-2 px-3 py-2 border border-green-300 text-green-700 bg-green-50 rounded-lg hover:bg-green-100 text-sm">
