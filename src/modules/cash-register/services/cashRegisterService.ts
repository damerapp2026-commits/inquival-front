...
import type { CashRegisterPeriodSummary } from '../../../shared/types';
export const cashRegisterService = {
  ...
  getSummary: (params?: any): Promise<CashRegisterPeriodSummary> =>
    api.get('/cash-registers/summary', { params }).then((r) => r.data.data),
