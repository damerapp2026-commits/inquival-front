      ...
      <Modal isOpen={showEditModal} onClose={() => setShowEditModal(false)} title="Editar Crédito">
        <form onSubmit={handleEdit} className="space-y-4">
          <div className="bg-gray-50 p-3 rounded-lg text-sm">
            ...
            <div>Pagado: <span className="text-green-600 font-medium">S/ {selectedCredit?.paidAmount.toFixed(2)}</span></div>
          </div>
          <div>
      ...
      <Modal isOpen={showDeleteModal} onClose={() => setShowDeleteModal(false)} title="Eliminar Crédito">
        <div className="space-y-4">
          ...
          <div className="bg-gray-50 p-3 rounded-lg text-sm">
            ...
            <div>Pagado: <span className="text-green-600">S/ {selectedCredit?.paidAmount.toFixed(2)}</span></div>
