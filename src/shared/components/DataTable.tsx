...
interface DataTableProps<T> { columns: Column<T>[]; data: T[]; isLoading?: boolean; onRowClick?: (item: T) => void; hoverClass?: string; rowClassName?: (item: T) => string; }

export function DataTable<T extends { id?: string }>({ columns, data, isLoading, onRowClick, hoverClass, rowClassName }: DataTableProps<T>) {
