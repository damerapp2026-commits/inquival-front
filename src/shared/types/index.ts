...
export interface PurchaseOrder { id: string; orderNumber: string; companyId: string; supplier: string; supplierId?: string; supplierRuc?: string; fiscalEntityId?: string; items: PurchaseItem[]; totalCost: number; totalCostUsd?: number; exchangeRate?: number; currency?: 'PEN' | 'USD'; paymentType?: 'CONTADO' | 'CREDITO' | 'BONIFICACION'; paymentMethodId?: string; paymentScheduleType?: 'SINGLE_DATE' | 'INSTALLMENTS'; dueDate?: string; installments?: { amount: number; dueDate: string }[]; documentType?: PurchaseDocumentType; documentSeries?: string; documentNumber?: string; issueDate?: string; notes?: string; status: PurchaseOrderStatus; convertedPurchaseId?: string; convertedAt?: string; createdAt: string; updatedAt?: string; }
