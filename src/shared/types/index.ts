...
export interface Sale { id: string; companyId?: string; clientId?: string; clientName?: string; items: SaleItem[]; total: number; voucherType: string; isCredit: boolean; payments: SalePayment[]; sellerId?: string; sellerName?: string; createdBy?: string; isCancelled?: boolean; cancelledBy?: string; cancelledAt?: string; cancelReason?: string; date: string; series?: string; number?: number; saleNumber?: string; createdAt: string; }
